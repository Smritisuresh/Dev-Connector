      ...
      <form className="form" onSubmit={onSubmit}>
        ...
        <div className="form-group">
          <input
            ...
            placeholder="Website"
            name="website"
            onChange={onChange} value={website}
          />
          <small className="form-text">
        ...
        <div className="form-group">
          <input
            ...
            name="location"
            onChange={onChange} value={location}
          />
          <small className="form-text">
        ...
        <div className="form-group">
          <input
            ...
            name="githubusername"
            onChange={onChange}value={githubusername}
          />
          <small className="form-text">
          ...
          <Fragment>
            ...
            <div className="form-group social-input">
              ...
              <input
                ...
                name="facebook"
                onChange={onChange} value={facebook}
              />
            </div>
            ...
            <div className="form-group social-input">
              ...
              <input
                ...
                name="linkedin"
                onChange={onChange} value={linkedin}
              />
            </div>
            ...
            <div className="form-group social-input">
              ...
              <input
                ...
                name="instagram"
                onChange={onChange} value={instagram}
              />
            </div>
          </Fragment>
        )}
